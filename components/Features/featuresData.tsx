...
const featuresData: Feature[] = [
  {
    ...
    paragraph:
      "Mimba + app is a mobile and web-based system that links expectant Mothers, to healthcare workers (Community Health Volunteers, Traditional Birth Attendants) and to connect to quality services; improve communication and health outcomes.",
  },
  {
    id: 1,
    icon: (
    ...
    title: "Lima",
    paragraph:
      "A cloud-based platform that links the producers of Agri-products to the farmers, including veterinary services.",
  },
  {
    id: 1,
    icon: (
    ...
    title: "KeNum",
    paragraph:
      "A mobile and integrated web platform that enables nurses and midwives in Kenya to access services offered by NCK from the comfort of their mobile phones.",
  },
  // {
  //   id: 1,
  //   icon: (
  ...
  //   paragraph:
  //     "KEMSA eMobile is a logistics management information system that is used to order health commodities in 47 counties. It has contributed to the reduction of turn around time from order to receipt of commodities at facilities from 64 days to 7 days.This project had demonstrated a successful transition from March 28, 2020",
  // },
  // {
  //   id: 1,
  //   icon: (
  ...
  //   paragraph:
  //     "LiMA has been developed, in partnership with icipe, as a cloud based agrovet platform that provides an end to end supply and logistics chain for farm inputs. With 1,000+ registered farmers with plans to expand this base to 300,000+, LiMA is continually being improved. March 28, 2020",
  // },
];
