...
const Hero = () => {
  ...
  const items = [
    { image: 'https://images.unsplash.com/photo-1485848395967-65dff62dc35b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2069&q=80', 
...
<div className="relative h-screen">
      {items.map((item, index) => (
        ...
        >
          <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: `url(${process.env.PUBLIC_URL + item.image})` }}>
