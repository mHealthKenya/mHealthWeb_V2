...
const Contact = () =>{
  return(
      <div className='flex justify-center w-500 bg-gray-200 p-4'>
        <div className="max-w-sm w-400 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 ">
   ...
   <p className="mb-2 text-sm text-gray-500 dark:text-gray-400">
      <a href="#" className="hover:underline">info@mhealth-kenya.org</a>
   </p>
